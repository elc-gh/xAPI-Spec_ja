...
<table>
    ...
    <td>ステートメントの目的語となる アクティビティ、エージェント、または別のステートメント。"I Did This" の "This" に相当。このプロパティの値として提供される目的語には "objectType" プロパティを含むべきであることに注意。指定しない場合は目的語はアクティビティであるとみなされる。</td><td>必須</td></tr>
...
LRS に記録したり LRS から読み出したりする方法があることは有益である。サブステートメント
に文書を添付したい場合、添付文書をステートメントアタッチメントオブジェクトとして、
...
* 他すべてのプロパティは stored を含め、変更せずに保持すること。 stored はステートメントが他システムへ渡った場合についても最新化されるべきである。
...
* stored を含めたその他すべてのプロパティを変更なしで保存する。ステートメントが他のシステムに送られた場合は、 stored は更新される。
